...
/**
 * Created by Patrick on 1/23/2017.
 */
public class HealthyBurger extends Hamburger{
    ...
    public double itemizeHamburger() {
        double hamburgerPrice = super.itemizeHamburger();//get the price so far

        if(this.healthyExtraName1 != null){
            hamburgerPrice += this.healthyExtraPrice1;
            System.out.println("added an extra price 1");
        }

        if(this.healthyExtraName2 != null){
            hamburgerPrice += this.healthyExtraPrice2;
            System.out.println("added an extra price 2");
        }
